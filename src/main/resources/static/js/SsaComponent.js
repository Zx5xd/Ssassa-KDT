 ...
 */const Qe="important",_t=" !"+Qe,At=Ke(class extends Je{constructor(i){var e;if(super(i),i.type!==We.ATTRIBUTE||i.name!=="style"||((e=i.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((e,t)=>{const r=i[t];return r==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(i,[e]){const{style:t}=i.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const r of this.ft)e[r]==null&&(this.ft.delete(r),r.includes("-")?t.removeProperty(r):t[r]=null);for(const r in e){const s=e[r];if(s!=null){this.ft.add(r);const o=typeof s=="string"&&s.endsWith(_t);r.includes("-")||o?t.setProperty(r,o?s.slice(0,-11):s,o?Qe:""):t[r]=s}}return M}});var kt=Object.defineProperty,zt=Object.getOwnPropertyDescriptor,oe=(i,e,t,r)=>{for(var s=r>1?void 0:r?zt(e,t):e,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=(r?n(e,t,s):n(s))||s);return r&&s&&kt(e,t,s),s};let H=class extends C{constructor(){super(...arguments),this.href="#",this.value="",this.bgColor="white",this.textColor="black"}render(){const i={first:this.classList.contains("first"),last:this.classList.contains("last")},e=Object.entries(i).filter(([,t])=>t).map(([t])=>t).join(" ");return f`
  ...
  `;oe([x({type:String})],H.prototype,"href",2);oe([x({type:String})],H.prototype,"value",2);oe([x({type:String})],H.prototype,"bgColor",2);oe([x({type:String})],H.prototype,"textColor",2);H=oe([T("category-item")],H);var Et=Object.defineProperty,St=Object.getOwnPropertyDescriptor,I=(i,e,t,r)=>{for(var s=r>1?void 0:r?St(e,t):e,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=(r?n(e,t,s):n(s))||s);return r&&s&&Et(e,t,s),s};let E=class extends C{constructor(){super(...arguments),this.pId=0,this.cId=0,this.ccId=0,this.pName="",this.src="",this.desc="",this.pReg="",this.defaultVariant=0,this.variants=null,this.checkedIds=new Set}get getImageUrl(){return`/pdr/img/${this.src}`}get getDate(){const i=new Date(this.pReg),e=i.getFullYear(),t=String(i.getMonth()+1).padStart(2,"0");return`${e}.${t}`}get getDefaultURI(){return this.variants&&this.defaultVariant!==0?`/pd/detail/${this.pId}_${this.defaultVariant}`:`/pd/detail/${this.pId}`}render(){var i;return f`
            <div class="p-item">
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Te=(i,e,t)=>{const r=new Map;for(let s=e;s<=t;s++)r.set(i[s],s);return r},Rt=Ke(class extends Je{constructor(i){if(super(i),i.type!==We.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let r;t===void 0?t=e:e!==void 0&&(r=e);const s=[],o=[];let n=0;for(const l of i)s[n]=r?r(l,n):n,o[n]=t(l,n),n++;return{values:o,keys:s}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,r]){const s=Ot(i),{values:o,keys:n}=this.dt(e,t,r);if(!Array.isArray(s))return this.ut=n,o;const l=this.ut??(this.ut=[]),a=[];let d,p,c=0,h=s.length-1,m=0,b=o.length-1;for(;c<=h&&m<=b;)if(s[c]===null)c++;else if(s[h]===null)h--;else if(l[c]===n[m])a[m]=q(s[c],o[m]),c++,m++;else if(l[h]===n[b])a[b]=q(s[h],o[b]),h--,b--;else if(l[c]===n[b])a[b]=q(s[c],o[b]),Y(i,a[b+1],s[c]),c++,b--;else if(l[h]===n[m])a[m]=q(s[h],o[m]),Y(i,s[c],s[h]),h--,m++;else if(d===void 0&&(d=Te(n,m,b),p=Te(l,c,h)),d.has(l[c]))if(d.has(l[h])){const _=p.get(n[m]),S=_!==void 0?s[_]:null;if(S===null){const w=Y(i,s[c]);q(w,o[m]),a[m]=w}else a[m]=q(S,o[m]),Y(i,s[c],S),s[_]=null;m++}else ge(s[h]),h--;else ge(s[c]),c++;for(;m<=b;){const _=Y(i,a[b+1]);q(_,o[m]),a[m++]=_}for(;c<=h;){const _=s[c++];_!==null&&ge(_)}return this.ut=n,Pt(i,a),M}});var Mt=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,he=(i,e,t,r)=>{for(var s=r>1?void 0:r?Ut(e,t):e,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=(r?n(e,t,s):n(s))||s);return r&&s&&Mt(e,t,s),s};let K=class extends C{constructor(){super(...arguments),this.categoryMap=new Map,this.products=[]}firstUpdated(i){this.addEventListener("select",this.handleSelect)}updated(i){i.has("basketSideEl")&&this.basketSideEl&&this.basketSideEl.addEventListener("remove",e=>this.onBasketRemove(e))}setProducts(i){this.products=i}updateProductById(i,e){this.products=this.products.map(t=>t.id===i?{...t,...e}:t)}setChecked(i,e,t){const r=this.renderRoot.querySelectorAll("product-item");for(const s of r)if(s.pId===i){s.setChecked(e,t);break}}handleSelect(i){var c;if(!this.basketSideEl||!this.categoryMap)return;const{categoryId:e,categoryChildId:t,product:r,checked:s}=i.detail,o=this.categoryMap.get(e);if(!o)return;const n=((c=o.variants.get(t))==null?void 0:c.name)||o.name;if(!n)return;const l=this.basketSideEl,{id:a,name:d="",price:p}=r;s?l.addProduct(n,a,d??"",p):l.removeProduct(n,a)}onBasketRemove(i){if(!this.basketSideEl)return;i.detail.product.forEach(t=>{const r=Array.from(this.renderRoot.querySelectorAll("product-item")).find(s=>{var n;return(n=s.variants)==null?void 0:n.some(l=>l.id===t.id)});r?r.setChecked(t.id,!1):console.warn("상품을 찾을 수 없습니다 (priceId):",t.id)})}getVariantToPrice(i){return i.variants.length>0?i.variants.map(e=>({id:e.id,name:e.name,price:e.price,schedule:e.price==0})):[{id:i.id,name:null,price:i.price,schedule:i.price==0}]}render(){return f`
            <div id="product-list">
    ...
    `;he([x({type:Object})],K.prototype,"categoryMap",2);he([x({type:Object})],K.prototype,"basketSideEl",2);he([x({type:Array})],K.prototype,"products",2);K=he([T("product-list")],K);function Tt(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var be={exports:{}},je;function jt(){return je||(je=1,function(i){var e=function(){var t=String.fromCharCode,r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",s="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$",o={};function n(a,d){if(!o[a]){o[a]={};for(var p=0;p<a.length;p++)o[a][a.charAt(p)]=p}return o[a][d]}var l={compressToBase64:function(a){if(a==null)return"";var d=l._compress(a,6,function(p){return r.charAt(p)});switch(d.length%4){default:case 0:return d;case 1:return d+"===";case 2:return d+"==";case 3:return d+"="}},decompressFromBase64:function(a){return a==null?"":a==""?null:l._decompress(a.length,32,function(d){return n(r,a.charAt(d))})},compressToUTF16:function(a){return a==null?"":l._compress(a,15,function(d){return t(d+32)})+" "},decompressFromUTF16:function(a){return a==null?"":a==""?null:l._decompress(a.length,16384,function(d){return a.charCodeAt(d)-32})},compressToUint8Array:function(a){for(var d=l.compress(a),p=new Uint8Array(d.length*2),c=0,h=d.length;c<h;c++){var m=d.charCodeAt(c);p[c*2]=m>>>8,p[c*2+1]=m%256}return p},decompressFromUint8Array:function(a){if(a==null)return l.decompress(a);for(var d=new Array(a.length/2),p=0,c=d.length;p<c;p++)d[p]=a[p*2]*256+a[p*2+1];var h=[];return d.forEach(function(m){h.push(t(m))}),l.decompress(h.join(""))},compressToEncodedURIComponent:function(a){return a==null?"":l._compress(a,6,function(d){return s.charAt(d)})},decompressFromEncodedURIComponent:function(a){return a==null?"":a==""?null:(a=a.replace(/ /g,"+"),l._decompress(a.length,32,function(d){return n(s,a.charAt(d))}))},compress:function(a){return l._compress(a,16,function(d){return t(d)})},_compress:function(a,d,p){if(a==null)return"";var c,h,m={},b={},_="",S="",w="",k=2,A=3,y=2,$=[],u=0,g=0,v;for(v=0;v<a.length;v+=1)if(_=a.charAt(v),Object.prototype.hasOwnProperty.call(m,_)||(m[_]=A++,b[_]=!0),S=w+_,Object.prototype.hasOwnProperty.call(m,S))w=S;else{if(Object.prototype.hasOwnProperty.call(b,w)){if(w.charCodeAt(0)<256){for(c=0;c<y;c++)u=u<<1,g==d-1?(g=0,$.push(p(u)),u=0):g++;for(h=w.charCodeAt(0),c=0;c<8;c++)u=u<<1|h&1,g==d-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1}else{for(h=1,c=0;c<y;c++)u=u<<1|h,g==d-1?(g=0,$.push(p(u)),u=0):g++,h=0;for(h=w.charCodeAt(0),c=0;c<16;c++)u=u<<1|h&1,g==d-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1}k--,k==0&&(k=Math.pow(2,y),y++),delete b[w]}else for(h=m[w],c=0;c<y;c++)u=u<<1|h&1,g==d-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1;k--,k==0&&(k=Math.pow(2,y),y++),m[S]=A++,w=String(_)}if(w!==""){if(Object.prototype.hasOwnProperty.call(b,w)){if(w.charCodeAt(0)<256){for(c=0;c<y;c++)u=u<<1,g==d-1?(g=0,$.push(p(u)),u=0):g++;for(h=w.charCodeAt(0),c=0;c<8;c++)u=u<<1|h&1,g==d-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1}else{for(h=1,c=0;c<y;c++)u=u<<1|h,g==d-1?(g=0,$.push(p(u)),u=0):g++,h=0;for(h=w.charCodeAt(0),c=0;c<16;c++)u=u<<1|h&1,g==d-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1}k--,k==0&&(k=Math.pow(2,y),y++),delete b[w]}else for(h=m[w],c=0;c<y;c++)u=u<<1|h&1,g==d-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1;k--,k==0&&(k=Math.pow(2,y),y++)}for(h=2,c=0;c<y;c++)u=u<<1|h&1,g==d-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1;for(;;)if(u=u<<1,g==d-1){$.push(p(u));break}else g++;return $.join("")},decompress:function(a){return a==null?"":a==""?null:l._decompress(a.length,32768,function(d){return a.charCodeAt(d)})},_decompress:function(a,d,p){var c=[],h=4,m=4,b=3,_="",S=[],w,k,A,y,$,u,g,v={val:p(0),position:d,index:1};for(w=0;w<3;w+=1)c[w]=w;for(A=0,$=Math.pow(2,2),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=d,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;switch(A){case 0:for(A=0,$=Math.pow(2,8),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=d,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;g=t(A);break;case 1:for(A=0,$=Math.pow(2,16),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=d,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;g=t(A);break;case 2:return""}for(c[3]=g,k=g,S.push(g);;){if(v.index>a)return"";for(A=0,$=Math.pow(2,b),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=d,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;switch(g=A){case 0:for(A=0,$=Math.pow(2,8),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=d,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;c[m++]=t(A),g=m-1,h--;break;case 1:for(A=0,$=Math.pow(2,16),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=d,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;c[m++]=t(A),g=m-1,h--;break;case 2:return S.join("")}if(h==0&&(h=Math.pow(2,b),b++),c[g])_=c[g];else if(g===m)_=k+k.charAt(0);else return null;S.push(_),c[m++]=k+_.charAt(0),h--,k=_,h==0&&(h=Math.pow(2,b),b++)}}};return l}();i!=null?i.exports=e:typeof angular<"u"&&angular!=null&&angular.module("LZString",[]).factory("LZString",function(){return e})}(be)),be.exports}var Lt=jt();const Le=Tt(Lt);var Dt=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,_e=(i,e,t,r)=>{for(var s=r>1?void 0:r?qt(e,t):e,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=(r?n(e,t,s):n(s))||s);return r&&s&&Dt(e,t,s),s};let se=class extends C{constructor(){super(...arguments),this.category=[],this.basket=new Map}addProduct(i,e,t,r){let s=[];if(this.basket.has(i)&&(s=this.basket.get(i)),!s.some(n=>n.id===e))s.push({id:e,name:t,price:r,amount:1});else{let n=this.getProductAmount(s,e);n!=null&&(n++,s=this.updateAmountImmutable(s,e,n))}this.basket.set(i,s),this.requestUpdate()}minusProduct(i,e){let t=[];if(this.basket.has(i)&&(t=this.basket.get(i)),t.some(s=>s.id===e)){let s=this.getProductAmount(t,e);if(s)if(s>1)s--,this.updateAmountImmutable(t,e,s),this.dispatchChange();else{const o=this.findById(t,e);t=this.removeById(t,e),o&&this.dispatchRemove(o)}}this.basket.set(i,t),this.requestUpdate()}removeProduct(i,e){let t=[];if(this.basket.has(i)&&(t=this.basket.get(i)),t.some(s=>s.id===e)){const s=this.findById(t,e);t=this.removeById(t,e),s&&this.dispatchRemove(s)}if(t.length==0){this.basket.delete(i),this.requestUpdate();return}this.basket.set(i,t),this.requestUpdate()}productClear(){this.dispatchRemoves(),this.basket.clear(),this.requestUpdate()}getProductAmount(i,e){const t=i.find(r=>r.id===e);return t!=null?t.amount:null}updateAmountImmutable(i,e,t){return i.map(r=>r.id===e?{...r,amount:t}:r)}findById(i,e){return i.find(t=>t.id===e)}removeById(i,e){return i.filter(t=>t.id!==e)}get calculateTotalPrice(){let i=0;for(const[,e]of this.basket)for(const t of e)i+=t.price*t.amount;return i}get compressedData(){const i=Array.from(this.basket.entries()),e=JSON.stringify(i);return Le.compressToBase64(e)}set decompressedData(i){const e=Le.decompressFromBase64(i);if(!e)throw new Error("압축 해제 실패");const t=JSON.parse(e);this.basket=new Map(Object.entries(t))}dispatchChange(){const i=this.basket;this.dispatchEvent(new CustomEvent("change",{detail:{basket:i},bubbles:!0,composed:!0}))}dispatchRemove(i){const e={id:i.id,price:i.price,name:i.name,schedule:!0};this.dispatchEvent(new CustomEvent("remove",{detail:{product:[e]},bubbles:!0,composed:!0}))}dispatchRemoves(){const i=Array.from(this.basket.values()).flat().map(e=>({id:e.id,name:e.name,price:e.price,schedule:!0}));this.dispatchEvent(new CustomEvent("remove",{detail:{product:i}}))}handleInput(i,e,t){const r=i.target,s=Number(r.value);if(s<1||isNaN(s))return;const o=this.basket.get(e);if(!o)return;const n=o.map(l=>l.id===t?{...l,amount:s}:l);this.basket.set(e,n),this.requestUpdate()}basketContentRenderer(){return this.basket.size===0?f`
      <div id="basket-empty">
        비어있습니다
      </div>
  ...
  `;Ae([x({type:Array})],re.prototype,"filterRows",2);Ae([x({type:Boolean})],re.prototype,"expanded",2);re=Ae([T("filter-panel")],re);var Bt=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,L=(i,e,t,r)=>{for(var s=r>1?void 0:r?Ht(e,t):e,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=(r?n(e,t,s):n(s))||s);return r&&s&&Bt(e,t,s),s};const De=f`
...
`;let P=class extends C{constructor(){super(...arguments),this.comments=[],this.replyOpenMap=new Map,this.imageFiles=new Map,this.currentUserId="",this.editingCommentId=null,this.editingReplyId=null,this.editImageFiles=new Map}requestReply(i){this.dispatchEvent(new CustomEvent("request-reply-open",{detail:{commentId:i},bubbles:!0,composed:!0}))}allowReply(i){this.replyOpenMap=new Map(this.replyOpenMap.set(i,!0)),this.imageFiles.set(i,[]),this.requestUpdate()}cancelReply(i){this.replyOpenMap.delete(i),this.imageFiles.delete(i),this.replyOpenMap=new Map(this.replyOpenMap)}handleImageClick(i,e,t,r,s,o=!1){var a;i.preventDefault(),i.stopPropagation();let n=[],l=[];if(o){const d=(a=this.comments.find(p=>p.replies.some(c=>c.id===r)))==null?void 0:a.replies.find(p=>p.id===r);d!=null&&d.images&&(n=d.images,l=d.images.map((p,c)=>`답글 이미지 ${c+1}`))}else{const d=this.comments.find(p=>p.id===r);d!=null&&d.images&&(n=d.images,l=d.images.map((p,c)=>`댓글 이미지 ${c+1}`))}n.length>0&&this.showImageModal(n,l,s)}showImageModal(i,e,t){const r=document.querySelector(".image-modal");r&&document.body.removeChild(r);const s=document.createElement("div");s.className="image-modal",s.style.cssText=`
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
        ...
        `,i.length>1){const p=document.createElement("button");p.innerHTML="‹",p.style.cssText=`
                ...
                z-index: 10001;
            `,p.onmouseover=()=>p.style.background="rgba(255, 255, 255, 0.3)",p.onmouseout=()=>p.style.background="rgba(255, 255, 255, 0.2)",p.onclick=m=>{m.stopPropagation();const b=t>0?t-1:i.length-1;n.src=i[b]||"",l&&(l.textContent=e[b]||""),t=b},o.appendChild(p);const c=document.createElement("button");c.innerHTML="›",c.style.cssText=`
                position: absolute;
                right: 20px;
                top: 50%;
                transform: translateY(-50%);
                ...
                transition: background-color 0.2s ease;
                z-index: 10001;
            `,c.onmouseover=()=>c.style.background="rgba(255, 255, 255, 0.3)",c.onmouseout=()=>c.style.background="rgba(255, 255, 255, 0.2)",c.onclick=m=>{m.stopPropagation();const b=t<i.length-1?t+1:0;n.src=i[b]||"",l&&(l.textContent=e[b]||""),t=b},o.appendChild(c);const h=document.createElement("div");h.textContent=`${t+1} / ${i.length}`,h.style.cssText=`
                position: absolute;
                top: 20px;
                left: 50%;
                      ...
                      <div class="comment-images">
                        ${e.images.map((l,a)=>f`
                          <img 
                            ...
                            alt="댓글 이미지" 
                            class="comment-image" 
                            @click=${d=>this.handleImageClick(d,l,`댓글 이미지 ${a+1}`,e.id,a)}
                          />
                        `)}
                      </div>
                    `:""}
                            ...
                            <div class="comment-images">
                              ${l.images.map((p,c)=>f`
                                <img 
                                  ...
                                  alt="답글 이미지" 
                                  class="comment-image" 
                                  @click=${h=>this.handleImageClick(h,p,`답글 이미지 ${c+1}`,l.id,c,!0)}
                                />
                              `)}
                            </div>
                          `:""}
                            ...
                            ${this.editingReplyId===l.id?f`
                              <div class="edit-form">
                                ...
                                ${(a=this.editImageFiles.get(l.id))!=null&&a.length?f`
                                  <div class="image-preview">
                                    ${(d=this.editImageFiles.get(l.id))==null?void 0:d.map((p,c)=>f`
                                      <div class="image-preview-item">
                                        <img src=${URL.createObjectURL(p)} alt="새 이미지 미리보기" />
                                        <button 
                                          class="remove-btn" 
                                          @click=${()=>this.removeEditImage(l.id,c)}
                                          title="이미지 제거"
                                        >×</button>
                                      </div>
                                    `)}
    ...
    `;ne([x({type:String})],V.prototype,"author",2);ne([x({type:Number})],V.prototype,"userId",2);ne([j()],V.prototype,"selectedImages",2);ne([j()],V.prototype,"selectedType",2);V=ne([T("review-input")],V);
