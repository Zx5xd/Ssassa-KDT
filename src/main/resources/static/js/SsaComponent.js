 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function $t(t){return(e,i)=>{const{slot:r,selector:s}={},o="slot"+(r?`[name=${r}]`:":not([name])");return yt(e,i,{get(){var a;const n=(a=this.renderRoot)==null?void 0:a.querySelector(o),d=(n==null?void 0:n.assignedElements(t))??[];return s===void 0?d:d.filter(c=>c.matches(s))}})}}var wt=Object.defineProperty,xt=Object.getOwnPropertyDescriptor,Ze=(t,e,i,r)=>{for(var s=r>1?void 0:r?xt(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(s=(r?n(e,i,s):n(s))||s);return r&&s&&wt(e,i,s),s};let de=class extends C{updated(){if(this.items.forEach(t=>{t.classList.remove("first","last"),t.style.removeProperty("--radius"),t.style.removeProperty("--radius-hover")}),this.items.length>0){const t=this.items[0];t&&(t.classList.add("first"),t.style.setProperty("--radius","var(--radius-2) var(--radius-2) 0 0"),t.style.setProperty("--radius-hover","var(--radius-2) var(--radius-2) var(--radius-2) 0"))}if(this.items.length>1){const t=this.items[this.items.length-1];t&&(t.classList.add("last"),t.style.setProperty("--radius","0 0 var(--radius-2) var(--radius-2)"),t.style.setProperty("--radius-hover","0 var(--radius-2) var(--radius-2) var(--radius-2)"))}}render(){return f`<slot></slot>`}};de.styles=U`
    :host {
      height: fit-content;
      display: flex;
  ...
  `;Ze([$t()],de.prototype,"items",2);de=Ze([j("category-elem")],de);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Qe="important",_t=" !"+Qe,At=Ke(class extends Je{constructor(t){var e;if(super(t),t.type!==We.ATTRIBUTE||t.name!=="style"||((e=t.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{const r=t[i];return r==null?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(t,[e]){const{style:i}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const r of this.ft)e[r]==null&&(this.ft.delete(r),r.includes("-")?i.removeProperty(r):i[r]=null);for(const r in e){const s=e[r];if(s!=null){this.ft.add(r);const o=typeof s=="string"&&s.endsWith(_t);r.includes("-")||o?i.setProperty(r,o?s.slice(0,-11):s,o?Qe:""):i[r]=s}}return M}});var kt=Object.defineProperty,zt=Object.getOwnPropertyDescriptor,oe=(t,e,i,r)=>{for(var s=r>1?void 0:r?zt(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(s=(r?n(e,i,s):n(s))||s);return r&&s&&kt(e,i,s),s};let H=class extends C{constructor(){super(...arguments),this.href="#",this.value="",this.bgColor="white",this.textColor="black"}render(){const t={first:this.classList.contains("first"),last:this.classList.contains("last")},e=Object.entries(t).filter(([,i])=>i).map(([i])=>i).join(" ");return f`
  ...
  `;oe([x({type:String})],H.prototype,"href",2);oe([x({type:String})],H.prototype,"value",2);oe([x({type:String})],H.prototype,"bgColor",2);oe([x({type:String})],H.prototype,"textColor",2);H=oe([j("category-item")],H);var Et=Object.defineProperty,St=Object.getOwnPropertyDescriptor,I=(t,e,i,r)=>{for(var s=r>1?void 0:r?St(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(s=(r?n(e,i,s):n(s))||s);return r&&s&&Et(e,i,s),s};let E=class extends C{constructor(){super(...arguments),this.pId=0,this.cId=0,this.ccId=0,this.pName="",this.src="",this.desc="",this.pReg="",this.defaultVariant=0,this.variants=null,this.checkedIds=new Set}get getImageUrl(){return`/pdr/img/${this.src}`}get getDate(){const t=new Date(this.pReg),e=t.getFullYear(),i=String(t.getMonth()+1).padStart(2,"0");return`${e}.${i}`}get getDefaultURI(){return this.variants&&this.defaultVariant!==0?`/pd/detail/${this.pId}_${this.defaultVariant}`:`/pd/detail/${this.pId}`}render(){var t;return f`
            <div class="p-item">
        ...
        `}priceRender(t){const e=this.checkedIds.has(t.id),i=f`
    ...
    `;I([x({type:Number})],E.prototype,"pId",2);I([x({type:Number})],E.prototype,"cId",2);I([x({type:Number})],E.prototype,"ccId",2);I([x({type:String})],E.prototype,"pName",2);I([x({type:String})],E.prototype,"src",2);I([x({type:String})],E.prototype,"desc",2);I([x({type:String})],E.prototype,"pReg",2);I([x({type:Number})],E.prototype,"defaultVariant",2);I([x({type:Array})],E.prototype,"variants",2);I([T()],E.prototype,"checkedIds",2);E=I([j("product-item")],E);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Ct}=mt,Ue=()=>document.createComment(""),Y=(t,e,i)=>{var o;const r=t._$AA.parentNode,s=e===void 0?t._$AB:e._$AA;if(i===void 0){const n=r.insertBefore(Ue(),s),d=r.insertBefore(Ue(),s);i=new Ct(n,d,t,t.options)}else{const n=i._$AB.nextSibling,d=i._$AM,a=d!==t;if(a){let c;(o=i._$AQ)==null||o.call(i,t),i._$AM=t,i._$AP!==void 0&&(c=t._$AU)!==d._$AU&&i._$AP(c)}if(n!==s||a){let c=i._$AA;for(;c!==n;){const p=c.nextSibling;r.insertBefore(c,s),c=p}}}return i},q=(t,e,i=t)=>(t._$AI(e,i),t),It={},Pt=(t,e=It)=>t._$AH=e,Ot=t=>t._$AH,ge=t=>{var r;(r=t._$AP)==null||r.call(t,!1,!0);let e=t._$AA;const i=t._$AB.nextSibling;for(;e!==i;){const s=e.nextSibling;e.remove(),e=s}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const je=(t,e,i)=>{const r=new Map;for(let s=e;s<=i;s++)r.set(t[s],s);return r},Rt=Ke(class extends Je{constructor(t){if(super(t),t.type!==We.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,i){let r;i===void 0?i=e:e!==void 0&&(r=e);const s=[],o=[];let n=0;for(const d of t)s[n]=r?r(d,n):n,o[n]=i(d,n),n++;return{values:o,keys:s}}render(t,e,i){return this.dt(t,e,i).values}update(t,[e,i,r]){const s=Ot(t),{values:o,keys:n}=this.dt(e,i,r);if(!Array.isArray(s))return this.ut=n,o;const d=this.ut??(this.ut=[]),a=[];let c,p,l=0,h=s.length-1,m=0,b=o.length-1;for(;l<=h&&m<=b;)if(s[l]===null)l++;else if(s[h]===null)h--;else if(d[l]===n[m])a[m]=q(s[l],o[m]),l++,m++;else if(d[h]===n[b])a[b]=q(s[h],o[b]),h--,b--;else if(d[l]===n[b])a[b]=q(s[l],o[b]),Y(t,a[b+1],s[l]),l++,b--;else if(d[h]===n[m])a[m]=q(s[h],o[m]),Y(t,s[l],s[h]),h--,m++;else if(c===void 0&&(c=je(n,m,b),p=je(d,l,h)),c.has(d[l]))if(c.has(d[h])){const _=p.get(n[m]),S=_!==void 0?s[_]:null;if(S===null){const w=Y(t,s[l]);q(w,o[m]),a[m]=w}else a[m]=q(S,o[m]),Y(t,s[l],S),s[_]=null;m++}else ge(s[h]),h--;else ge(s[l]),l++;for(;m<=b;){const _=Y(t,a[b+1]);q(_,o[m]),a[m++]=_}for(;l<=h;){const _=s[l++];_!==null&&ge(_)}return this.ut=n,Pt(t,a),M}});var Mt=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,he=(t,e,i,r)=>{for(var s=r>1?void 0:r?Ut(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(s=(r?n(e,i,s):n(s))||s);return r&&s&&Mt(e,i,s),s};let K=class extends C{constructor(){super(...arguments),this.categoryMap=new Map,this.products=[]}firstUpdated(t){this.addEventListener("select",this.handleSelect)}updated(t){t.has("basketSideEl")&&this.basketSideEl&&this.basketSideEl.addEventListener("remove",e=>this.onBasketRemove(e))}setProducts(t){this.products=t}updateProductById(t,e){this.products=this.products.map(i=>i.id===t?{...i,...e}:i)}setChecked(t,e,i){const r=this.renderRoot.querySelectorAll("product-item");for(const s of r)if(s.pId===t){s.setChecked(e,i);break}}handleSelect(t){var l;if(!this.basketSideEl||!this.categoryMap)return;const{categoryId:e,categoryChildId:i,product:r,checked:s}=t.detail,o=this.categoryMap.get(e);if(!o)return;const n=((l=o.variants.get(i))==null?void 0:l.name)||o.name;if(!n)return;const d=this.basketSideEl,{id:a,name:c="",price:p}=r;s?d.addProduct(n,a,c??"",p):d.removeProduct(n,a)}onBasketRemove(t){if(!this.basketSideEl)return;t.detail.product.forEach(i=>{const r=Array.from(this.renderRoot.querySelectorAll("product-item")).find(s=>{var n;return(n=s.variants)==null?void 0:n.some(d=>d.id===i.id)});r?r.setChecked(i.id,!1):console.warn("상품을 찾을 수 없습니다 (priceId):",i.id)})}getVariantToPrice(t){return t.variants.length>0?t.variants.map(e=>({id:e.id,name:e.name,price:e.price,schedule:e.price==0})):[{id:t.id,name:null,price:t.price,schedule:t.price==0}]}render(){return f`
            <div id="product-list">
                ${Rt(this.products,t=>t.id,t=>f`
                  <product-item
                          .pId=${t.id}
                          .cId=${t.categoryId}
    ...
    `;he([x({type:Object})],K.prototype,"categoryMap",2);he([x({type:Object})],K.prototype,"basketSideEl",2);he([x({type:Array})],K.prototype,"products",2);K=he([j("product-list")],K);function jt(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var be={exports:{}},Te;function Tt(){return Te||(Te=1,function(t){var e=function(){var i=String.fromCharCode,r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",s="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$",o={};function n(a,c){if(!o[a]){o[a]={};for(var p=0;p<a.length;p++)o[a][a.charAt(p)]=p}return o[a][c]}var d={compressToBase64:function(a){if(a==null)return"";var c=d._compress(a,6,function(p){return r.charAt(p)});switch(c.length%4){default:case 0:return c;case 1:return c+"===";case 2:return c+"==";case 3:return c+"="}},decompressFromBase64:function(a){return a==null?"":a==""?null:d._decompress(a.length,32,function(c){return n(r,a.charAt(c))})},compressToUTF16:function(a){return a==null?"":d._compress(a,15,function(c){return i(c+32)})+" "},decompressFromUTF16:function(a){return a==null?"":a==""?null:d._decompress(a.length,16384,function(c){return a.charCodeAt(c)-32})},compressToUint8Array:function(a){for(var c=d.compress(a),p=new Uint8Array(c.length*2),l=0,h=c.length;l<h;l++){var m=c.charCodeAt(l);p[l*2]=m>>>8,p[l*2+1]=m%256}return p},decompressFromUint8Array:function(a){if(a==null)return d.decompress(a);for(var c=new Array(a.length/2),p=0,l=c.length;p<l;p++)c[p]=a[p*2]*256+a[p*2+1];var h=[];return c.forEach(function(m){h.push(i(m))}),d.decompress(h.join(""))},compressToEncodedURIComponent:function(a){return a==null?"":d._compress(a,6,function(c){return s.charAt(c)})},decompressFromEncodedURIComponent:function(a){return a==null?"":a==""?null:(a=a.replace(/ /g,"+"),d._decompress(a.length,32,function(c){return n(s,a.charAt(c))}))},compress:function(a){return d._compress(a,16,function(c){return i(c)})},_compress:function(a,c,p){if(a==null)return"";var l,h,m={},b={},_="",S="",w="",k=2,A=3,y=2,$=[],u=0,g=0,v;for(v=0;v<a.length;v+=1)if(_=a.charAt(v),Object.prototype.hasOwnProperty.call(m,_)||(m[_]=A++,b[_]=!0),S=w+_,Object.prototype.hasOwnProperty.call(m,S))w=S;else{if(Object.prototype.hasOwnProperty.call(b,w)){if(w.charCodeAt(0)<256){for(l=0;l<y;l++)u=u<<1,g==c-1?(g=0,$.push(p(u)),u=0):g++;for(h=w.charCodeAt(0),l=0;l<8;l++)u=u<<1|h&1,g==c-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1}else{for(h=1,l=0;l<y;l++)u=u<<1|h,g==c-1?(g=0,$.push(p(u)),u=0):g++,h=0;for(h=w.charCodeAt(0),l=0;l<16;l++)u=u<<1|h&1,g==c-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1}k--,k==0&&(k=Math.pow(2,y),y++),delete b[w]}else for(h=m[w],l=0;l<y;l++)u=u<<1|h&1,g==c-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1;k--,k==0&&(k=Math.pow(2,y),y++),m[S]=A++,w=String(_)}if(w!==""){if(Object.prototype.hasOwnProperty.call(b,w)){if(w.charCodeAt(0)<256){for(l=0;l<y;l++)u=u<<1,g==c-1?(g=0,$.push(p(u)),u=0):g++;for(h=w.charCodeAt(0),l=0;l<8;l++)u=u<<1|h&1,g==c-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1}else{for(h=1,l=0;l<y;l++)u=u<<1|h,g==c-1?(g=0,$.push(p(u)),u=0):g++,h=0;for(h=w.charCodeAt(0),l=0;l<16;l++)u=u<<1|h&1,g==c-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1}k--,k==0&&(k=Math.pow(2,y),y++),delete b[w]}else for(h=m[w],l=0;l<y;l++)u=u<<1|h&1,g==c-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1;k--,k==0&&(k=Math.pow(2,y),y++)}for(h=2,l=0;l<y;l++)u=u<<1|h&1,g==c-1?(g=0,$.push(p(u)),u=0):g++,h=h>>1;for(;;)if(u=u<<1,g==c-1){$.push(p(u));break}else g++;return $.join("")},decompress:function(a){return a==null?"":a==""?null:d._decompress(a.length,32768,function(c){return a.charCodeAt(c)})},_decompress:function(a,c,p){var l=[],h=4,m=4,b=3,_="",S=[],w,k,A,y,$,u,g,v={val:p(0),position:c,index:1};for(w=0;w<3;w+=1)l[w]=w;for(A=0,$=Math.pow(2,2),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=c,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;switch(A){case 0:for(A=0,$=Math.pow(2,8),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=c,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;g=i(A);break;case 1:for(A=0,$=Math.pow(2,16),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=c,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;g=i(A);break;case 2:return""}for(l[3]=g,k=g,S.push(g);;){if(v.index>a)return"";for(A=0,$=Math.pow(2,b),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=c,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;switch(g=A){case 0:for(A=0,$=Math.pow(2,8),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=c,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;l[m++]=i(A),g=m-1,h--;break;case 1:for(A=0,$=Math.pow(2,16),u=1;u!=$;)y=v.val&v.position,v.position>>=1,v.position==0&&(v.position=c,v.val=p(v.index++)),A|=(y>0?1:0)*u,u<<=1;l[m++]=i(A),g=m-1,h--;break;case 2:return S.join("")}if(h==0&&(h=Math.pow(2,b),b++),l[g])_=l[g];else if(g===m)_=k+k.charAt(0);else return null;S.push(_),l[m++]=k+_.charAt(0),h--,k=_,h==0&&(h=Math.pow(2,b),b++)}}};return d}();t!=null?t.exports=e:typeof angular<"u"&&angular!=null&&angular.module("LZString",[]).factory("LZString",function(){return e})}(be)),be.exports}var Lt=Tt();const Le=jt(Lt);var Dt=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,_e=(t,e,i,r)=>{for(var s=r>1?void 0:r?qt(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(s=(r?n(e,i,s):n(s))||s);return r&&s&&Dt(e,i,s),s};let se=class extends C{constructor(){super(...arguments),this.category=[],this.basket=new Map}addProduct(t,e,i,r){let s=[];if(this.basket.has(t)&&(s=this.basket.get(t)),!s.some(n=>n.id===e))s.push({id:e,name:i,price:r,amount:1});else{let n=this.getProductAmount(s,e);n!=null&&(n++,s=this.updateAmountImmutable(s,e,n))}this.basket.set(t,s),this.requestUpdate()}minusProduct(t,e){let i=[];if(this.basket.has(t)&&(i=this.basket.get(t)),i.some(s=>s.id===e)){let s=this.getProductAmount(i,e);if(s)if(s>1)s--,this.updateAmountImmutable(i,e,s),this.dispatchChange();else{const o=this.findById(i,e);i=this.removeById(i,e),o&&this.dispatchRemove(o)}}this.basket.set(t,i),this.requestUpdate()}removeProduct(t,e){let i=[];if(this.basket.has(t)&&(i=this.basket.get(t)),i.some(s=>s.id===e)){const s=this.findById(i,e);i=this.removeById(i,e),s&&this.dispatchRemove(s)}if(i.length==0){this.basket.delete(t),this.requestUpdate();return}this.basket.set(t,i),this.requestUpdate()}productClear(){this.dispatchRemoves(),this.basket.clear(),this.requestUpdate()}getProductAmount(t,e){const i=t.find(r=>r.id===e);return i!=null?i.amount:null}updateAmountImmutable(t,e,i){return t.map(r=>r.id===e?{...r,amount:i}:r)}findById(t,e){return t.find(i=>i.id===e)}removeById(t,e){return t.filter(i=>i.id!==e)}get calculateTotalPrice(){let t=0;for(const[,e]of this.basket)for(const i of e)t+=i.price*i.amount;return t}get compressedData(){const t=Array.from(this.basket.entries()),e=JSON.stringify(t);return Le.compressToBase64(e)}set decompressedData(t){const e=Le.decompressFromBase64(t);if(!e)throw new Error("압축 해제 실패");const i=JSON.parse(e);this.basket=new Map(Object.entries(i))}dispatchChange(){const t=this.basket;this.dispatchEvent(new CustomEvent("change",{detail:{basket:t},bubbles:!0,composed:!0}))}dispatchRemove(t){const e={id:t.id,price:t.price,name:t.name,schedule:!0};this.dispatchEvent(new CustomEvent("remove",{detail:{product:[e]},bubbles:!0,composed:!0}))}dispatchRemoves(){const t=Array.from(this.basket.values()).flat().map(e=>({id:e.id,name:e.name,price:e.price,schedule:!0}));this.dispatchEvent(new CustomEvent("remove",{detail:{product:t}}))}handleInput(t,e,i){const r=t.target,s=Number(r.value);if(s<1||isNaN(s))return;const o=this.basket.get(e);if(!o)return;const n=o.map(d=>d.id===i?{...d,amount:s}:d);this.basket.set(e,n),this.requestUpdate()}basketContentRenderer(){return this.basket.size===0?f`
      <div id="basket-empty">
        비어있습니다
      </div>
    `:this.category.length>0&&this.category.some(e=>this.basket.has(e.code))?f`
      ${this.category.filter(e=>this.basket.has(e.code)).sort((e,i)=>e.id-i.id).map(e=>{const i=this.basket.get(e.code);return f`
          ...
          `})}
    `:f`
    ${Array.from(this.basket.entries()).map(([e,i])=>f`
  ...
  `;_e([x({type:Array})],se.prototype,"category",2);_e([x({type:Map})],se.prototype,"basket",2);se=_e([j("basket-side")],se);var Nt=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,Ae=(t,e,i,r)=>{for(var s=r>1?void 0:r?Ft(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(s=(r?n(e,i,s):n(s))||s);return r&&s&&Nt(e,i,s),s};let re=class extends C{constructor(){super(...arguments),this.filterRows=[],this.expanded=!1,this.dispatchFilterChange=()=>{const t={};this.renderRoot.querySelectorAll('input[type="checkbox"]:checked').forEach(i=>{const r=i.name,s=i.value;t[r]||(t[r]=[]),t[r].push(this.deserializeValue(s))}),this.dispatchEvent(new CustomEvent("change",{detail:t,bubbles:!0,composed:!0}))}}deserializeValue(t){try{return JSON.parse(t)}catch{return t}}render(){const t=this.filterRows.filter(e=>e.isFilterable).sort((e,i)=>e.displayOrder-i.displayOrder);return f`
        ...
        ${t.map(e=>f`
          <div class="filter-row">
            ...
            <div class="filter-options ${this.expanded?"":"collapsed"}">
              ${e.valueList.slice().sort((i,r)=>r.weight-i.weight).map(i=>{let r;if(typeof i.value=="object")r=JSON.stringify(i.value);else{const s=Number(i.value);if(e.unit==="GB"&&!isNaN(s))if(s>=1e3){const o=s/1e3;r=`${o%1===0?o:o.toFixed(1)}TB`}else r=`${s}GB`;else r=`${i.value}${e.unit??""}`}return f`
                    <label>
                      <input
                        type="checkbox"
                        name=${e.attributeKey}
  ...
  `;Ae([x({type:Array})],re.prototype,"filterRows",2);Ae([x({type:Boolean})],re.prototype,"expanded",2);re=Ae([j("filter-panel")],re);var Bt=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,L=(t,e,i,r)=>{for(var s=r>1?void 0:r?Ht(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(s=(r?n(e,i,s):n(s))||s);return r&&s&&Bt(e,i,s),s};const De=f`
...
`;let P=class extends C{constructor(){super(...arguments),this.comments=[],this.replyOpenMap=new Map,this.imageFiles=new Map,this.currentUserId="",this.editingCommentId=null,this.editingReplyId=null,this.editImageFiles=new Map}requestReply(t){this.dispatchEvent(new CustomEvent("request-reply-open",{detail:{commentId:t},bubbles:!0,composed:!0}))}allowReply(t){this.replyOpenMap=new Map(this.replyOpenMap.set(t,!0)),this.imageFiles.set(t,[]),this.requestUpdate()}cancelReply(t){this.replyOpenMap.delete(t),this.imageFiles.delete(t),this.replyOpenMap=new Map(this.replyOpenMap)}handleImageClick(t,e,i,r,s,o=!1){var a;t.preventDefault(),t.stopPropagation();let n=[],d=[];if(o){const c=(a=this.comments.find(p=>p.replies.some(l=>l.id===r)))==null?void 0:a.replies.find(p=>p.id===r);c!=null&&c.images&&(n=c.images,d=c.images.map((p,l)=>`답글 이미지 ${l+1}`))}else{const c=this.comments.find(p=>p.id===r);c!=null&&c.images&&(n=c.images,d=c.images.map((p,l)=>`댓글 이미지 ${l+1}`))}n.length>0&&this.showImageModal(n,d,s)}showImageModal(t,e,i){const r=document.querySelector(".image-modal");r&&document.body.removeChild(r);const s=document.createElement("div");s.className="image-modal",s.style.cssText=`
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
        ...
        `,t.length>1){const p=document.createElement("button");p.innerHTML="‹",p.style.cssText=`
                ...
                z-index: 10001;
            `,p.onmouseover=()=>p.style.background="rgba(255, 255, 255, 0.3)",p.onmouseout=()=>p.style.background="rgba(255, 255, 255, 0.2)",p.onclick=m=>{m.stopPropagation();const b=i>0?i-1:t.length-1;n.src=t[b]||"",d&&(d.textContent=e[b]||""),i=b},o.appendChild(p);const l=document.createElement("button");l.innerHTML="›",l.style.cssText=`
                position: absolute;
                right: 20px;
                top: 50%;
                transform: translateY(-50%);
                ...
                transition: background-color 0.2s ease;
                z-index: 10001;
            `,l.onmouseover=()=>l.style.background="rgba(255, 255, 255, 0.3)",l.onmouseout=()=>l.style.background="rgba(255, 255, 255, 0.2)",l.onclick=m=>{m.stopPropagation();const b=i<t.length-1?i+1:0;n.src=t[b]||"",d&&(d.textContent=e[b]||""),i=b},o.appendChild(l);const h=document.createElement("div");h.textContent=`${i+1} / ${t.length}`,h.style.cssText=`
                position: absolute;
                top: 20px;
                left: 50%;
                ...
                border-radius: 20px;
                z-index: 10001;
            `,o.appendChild(h)}const d=document.createElement("div");d.textContent=e[i]||"",d.style.cssText=`
            position: absolute;
            bottom: 20px;
            left: 50%;
            transform: translateX(-50%);
      ...
      <div id="review-viewer">
        ...
        <div id="review-content">
          ${this.comments.map(t=>{var e,i,r,s;return f`
            <div class="comment">
              <div class="comment-body">
                ...
                <div class="comment-container">
                  <div class="comment-top">
                    ${t.author} <time class="reg">${this.formatDate(t.createdAt)}</time>
                  </div>
                  ${t.images&&t.images.length>0?f`
                    <div class="comment-images">
                      ${t.images.map((o,n)=>f`
                        <img 
                          ...
                          alt="댓글 이미지" 
                          class="comment-image" 
                          @click=${d=>this.handleImageClick(d,o,`댓글 이미지 ${n+1}`,t.id,n)}
                        />
                      `)}
                    </div>
                  `:""}
                                          <div class="comment-content">
                          ${this.editingCommentId!==t.id?f`
                            ${t.type==="question"?f`<span class="question-badge">질문</span>`:""}
                            ${t.type==="review"?f`<span class="review-badge">후기</span>`:""}
                            ${t.type==="answer"?f`<span class="answer-badge">답변</span>`:""}
                          `:""}
                          ${this.editingCommentId===t.id?f`
                      <div class="edit-form">
                        <div class="reply-toolbar">
                          ...
                          <div class="button-group">
                            <button @click=${()=>this.submitEdit(t.id)} class="reply-submit-btn">저장</button>
                            <button @click=${()=>this.cancelEdit(t.id)} class="reply-cancel-btn">취소</button>
                          </div>
                        </div>
                        ...
                        ${(e=this.editImageFiles.get(t.id))!=null&&e.length?f`
                          <div class="image-preview">
                            ${(i=this.editImageFiles.get(t.id))==null?void 0:i.map((o,n)=>f`
                              <div class="image-preview-item">
                                <img src=${URL.createObjectURL(o)} alt="새 이미지 미리보기" />
                                <button 
                                  class="remove-btn" 
                  ...
                  <div class="comment-bottom">
                    ${this.editingCommentId!==t.id?f`
                      <div class="comment-bl">
                        <div class="comment-reply-btn" @click=${()=>this.requestReply(t.id)}>답글</div>
                      </div>
                    `:""}
                    ${this.isAuthor(t)&&this.editingCommentId!==t.id?f`
                      <div class="comment-br">
                        <button class="edit-btn" @click=${()=>this.editComment(t.id)}>수정</button>
                        <button class="delete-btn" @click=${()=>this.deleteComment(t.id)}>삭제</button>
                      </div>
                    `:""}
                  </div>
                </div>
              ...
              ${t.replies.length>0||this.replyOpenMap.get(t.id)?f`
                <div class="comment-sub">
                  ${t.replies.map(o=>{var n,d;return f`
                    <div class="comment-body">
                      ...
                      <div class="comment-container">
                        <div class="comment-top">
                          ${o.author} <time class="reg">${this.formatDate(o.createdAt)}</time>
                        </div>
                        ${o.images&&o.images.length>0?f`
                          <div class="comment-images">
                            ${o.images.map((a,c)=>f`
                              <img 
                                src=${a} 
                                alt="답글 이미지" 
                                class="comment-image" 
                                @click=${p=>this.handleImageClick(p,a,`답글 이미지 ${c+1}`,o.id,c,!0)}
                              />
                            `)}
                          </div>
                        `:""}
                                                <div class="comment-content">
                          ${this.editingReplyId!==o.id?f`
                            ${o.type==="question"?f`<span class="question-badge">질문</span>`:""}
                            ${o.type==="review"?f`<span class="review-badge">후기</span>`:""}
                            ${o.type==="answer"?f`<span class="answer-badge">답변</span>`:""}
                          `:""}
                          ${this.editingReplyId===o.id?f`
                            <div class="edit-form">
                              <div class="reply-toolbar">
                                ...
                                <div class="button-group">
                                  <button @click=${()=>this.submitEdit(o.id)} class="reply-submit-btn">저장</button>
                                  <button @click=${()=>this.cancelEdit(o.id)} class="reply-cancel-btn">취소</button>
                                </div>
                              </div>
                              ...
                              ${(n=this.editImageFiles.get(o.id))!=null&&n.length?f`
                                <div class="image-preview">
                                  ${(d=this.editImageFiles.get(o.id))==null?void 0:d.map((a,c)=>f`
                                    <div class="image-preview-item">
                                      <img src=${URL.createObjectURL(a)} alt="새 이미지 미리보기" />
                                      <button 
                                        class="remove-btn" 
                                        @click=${()=>this.removeEditImage(o.id,c)}
                                        title="이미지 제거"
                                      >×</button>
                                    </div>
                                  `)}
                        ...
                        <div class="comment-bottom">
                          ...
                          ${this.isAuthor(o)&&this.editingReplyId!==o.id?f`
                            <div class="comment-br">
                              <button class="edit-btn" @click=${()=>this.editReply(o.id)}>수정</button>
                              <button class="delete-btn" @click=${()=>this.deleteComment(o.id)}>삭제</button>
                            </div>
                          `:""}
                        </div>
                      </div>
                    ...
                    <div class="comment-body reply-form">
                      ...
                      <div class="comment-reply-container">
                        <div class="reply-toolbar">
                          ...
                          <div class="button-group">
                            <button @click=${()=>this.submitReply(t.id)} class="reply-submit-btn">등록</button>
                            <button @click=${()=>this.cancelReply(t.id)} class="reply-cancel-btn">취소</button>
                          </div>
                        </div>
                        
                        ${(r=this.imageFiles.get(t.id))!=null&&r.length?f`
                          <div class="image-preview">
                            ${(s=this.imageFiles.get(t.id))==null?void 0:s.map((o,n)=>f`
                              <div class="image-preview-item">
                                <img src=${URL.createObjectURL(o)} alt="미리보기" />
                                <button 
                                  class="remove-btn" 
    ...
    `;L([x({type:Array})],P.prototype,"comments",2);L([T()],P.prototype,"replyOpenMap",2);L([T()],P.prototype,"imageFiles",2);L([x({type:String})],P.prototype,"currentUserId",2);L([T()],P.prototype,"editingCommentId",2);L([T()],P.prototype,"editingReplyId",2);L([T()],P.prototype,"editImageFiles",2);P=L([j("review-viewer")],P);var Vt=Object.defineProperty,Zt=Object.getOwnPropertyDescriptor,ne=(t,e,i,r)=>{for(var s=r>1?void 0:r?Zt(e,i):e,o=t.length-1,n;o>=0;o--)(n=t[o])&&(s=(r?n(e,i,s):n(s))||s);return r&&s&&Vt(e,i,s),s};let V=class extends C{constructor(){super(...arguments),this.author="현재 사용자",this.userId=1,this.selectedImages=[],this.selectedType=null}handleTypeChange(t){const e=t.target;this.selectedType=e.id==="re"?"review":"question"}handleImageUpload(){if(!this.selectedType){alert("후기 또는 질문을 먼저 선택해주세요.");return}const t=document.createElement("input");t.type="file",t.accept="image/*",t.multiple=!0,t.onchange=e=>{const i=Array.from(e.target.files||[]);this.selectedImages=[...this.selectedImages,...i],this.requestUpdate()},t.click()}removeImage(t){this.selectedImages.splice(t,1),this.selectedImages=[...this.selectedImages],this.requestUpdate()}handleSubmit(){const t=this.renderRoot.querySelector("#review-textarea"),e=t.value.trim();if(!this.selectedType){alert("후기 또는 질문을 선택해주세요.");return}if(!e&&this.selectedImages.length===0){alert("내용을 입력하거나 이미지를 추가해주세요.");return}const i=this.selectedImages.map(s=>URL.createObjectURL(s));this.dispatchEvent(new CustomEvent("review-submitted",{detail:{type:this.selectedType,content:e,images:this.selectedImages,imageUrls:i,author:this.author,userId:this.userId},bubbles:!0,composed:!0})),t.value="",this.selectedImages=[],this.selectedType=null,this.renderRoot.querySelectorAll('input[type="radio"]').forEach(s=>s.checked=!1),this.requestUpdate()}render(){return f`
    ...
    `;ne([x({type:String})],V.prototype,"author",2);ne([x({type:Number})],V.prototype,"userId",2);ne([T()],V.prototype,"selectedImages",2);ne([T()],V.prototype,"selectedType",2);V=ne([j("review-input")],V);
